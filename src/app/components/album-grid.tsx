  ...
  return (
    <>
      <div ref={scrollRef} className="flex-1 overflow-y-auto overlay-scroll">
        <div className={`grid ${viewMode === "grid3" ? "grid-cols-3" : "grid-cols-2"} lg:grid-cols-5 xl:grid-cols-6 gap-3 pl-[16px] pr-[32px] lg:px-[24px] pt-[12px]`} style={{ paddingBottom: "var(--scroll-bottom-pad)" }}>
